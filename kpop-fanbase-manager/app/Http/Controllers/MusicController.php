...
class MusicController extends Controller
{
    ...
    public function store(Request $request, Group $group)
    {
        ...
        return redirect()->route('groups.musics.index', $group)->with('success', 'Music added successfully.');
    }
    ...
    public function update(Request $request, Group $group, Music $music)
    {
        ...
        return redirect()->route('groups.musics.show', [$group, $music])->with('success', 'Music updated successfully.');
    }

    public function destroy(Group $group, Music $music)
    {
        $music->delete();
        return redirect()->route('groups.musics.index', $group)->with('success', 'Music deleted successfully.');
    }
}
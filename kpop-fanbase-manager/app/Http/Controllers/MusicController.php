...
class MusicController extends Controller
{
    ...
    public function store(Request $request, Group $group)
    {
        ...
        return redirect()->route('groups.musics.index', $group)->with('success', 'Música adicionada com sucesso.'); //
    }
    ...
    public function update(Request $request, Group $group, Music $music)
    {
        ...
        return redirect()->route('groups.musics.show', [$group, $music])->with('success', 'Música atualizada com sucesso.'); //
    }

    public function destroy(Group $group, Music $music)
    {
        $music->delete(); //
        return redirect()->route('groups.musics.index', $group)->with('success', 'Música deletada com sucesso.'); //
    }
}